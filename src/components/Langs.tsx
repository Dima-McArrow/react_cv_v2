...
export const Langs = () => {
  const handleLangClick = () => {
    ...
    const langsSelect = document.querySelector(".langs_select");

    //check if langs_select is visible
    if (currentLang?.querySelector(".langs_select")) return;

    if (currentLang) {
      langsSelect?.classList.toggle("visible");
    }
  };

  return (
    <div className="langs_container" onClick={handleLangClick}>
